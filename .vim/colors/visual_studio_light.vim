" Vim color file
" Maintainer: Marcin Majkowski <pl.marcin.m@gmail.com>
" Last Change: 2015-02-11
"
" This color file is a modification of the "summerfruit256" color scheme by
" Martin Baeuml. The colors are translated using Henry So's programmatic
" approximation of gui colors from his "desert256" color scheme.
"
" The original "summerfruit256" color scheme and "desert256" are available from vim.org.
...
let g:colors_name="visual_studio_light"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("NonText", "438ec3", "ffffff", "") " updated

    " Search
    call <SID>X("Search", "", "add8e6", "") " updated
    call <SID>X("IncSearch", "", "add8e6", "") " updated
    ...
    call <SID>X("CursorLine", "", "", "none") " updated
    call <SID>X("LineNr", "2b91af", "", "none") " updated
    ...
    " Syntax Elements
    call <SID>X("String", "a31515", "", "") " updated
    call <SID>X("Constant", "0086d2", "", "")
    call <SID>X("Number", "000000", "", "") " updated
    call <SID>X("Statement", "0000ff", "", "bold") " updated
    call <SID>X("Function", "000000", "", "bold") " updated
    call <SID>X("PreProc", "0000ff", "", "") " updated
    call <SID>X("Comment", "008000", "", "") " updated
    call <SID>X("Type", "0000ff", "", "") " updated
